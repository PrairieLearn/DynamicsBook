...
$(document).ready(function() {
    ...
    var rko_fw_c = new PrairieDrawAnim("rko-fw-c", function(t) {
    ...
    var rko_fr_c = new PrairieDraw("rko-fr-c", function() {
        this.setUnits(3, 3 / this.goldenRatio);
    ...
    var rko_xp_c = new PrairieDraw("rko-xp-c", function() {
    ...
    var rko_xc_c = new PrairieDraw("rko-xc-c", function() {
        this.setUnits(12, 6);
    ...
    var rko_fd_c = new PrairieDrawAnim("rko-fd-c", function(t) {
        this.setUnits(6, 4);
